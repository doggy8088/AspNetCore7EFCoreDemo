...
namespace AspNetCore7EFCoreDemo.Models
{
    ...
    public partial class ContosoUniversityContextProcedures : IContosoUniversityContextProcedures
    {
        ...
        public virtual async Task<List<GetCourseInfoResult>> GetCourseInfoAsync(OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<GetCourseInfoResult>("EXEC @returnValue = [dbo].[GetCourseInfo]", sqlParameters, cancellationToken);
